            ...
            <table border="1" style="width: 100%; border-collapse: collapse;" class="admin-data-table">
                <tr>
                    ...
                    <td style="width: 250px;">
                        <el-checkbox
                            v-show="accessLevel.searchLevels.length > 0"
                            :indeterminate="searchLevels.isIndeterminate"
                            v-model="searchLevels.checkAll"
                            @change="handleLevelCheckAllChange($event, searchLevels, 0)"
                            >全选</el-checkbox
                        >
                        <br />
                        <el-checkbox-group
                            v-model="searchLevels.checkedCities"
                ...
                <tr>
                    ...
                    <td style="width: 250px;">
                        <el-checkbox
                            v-show="accessLevel.downloadLevels.length > 0"
                            :indeterminate="downloadLevels.isIndeterminate"
                            v-model="downloadLevels.checkAll"
                            @change="handleLevelCheckAllChange($event, searchLevels, 0)"
                            >全选</el-checkbox
                        >
                        <br />
                        <el-checkbox-group
                            v-model="downloadLevels.checkedCities"
                ...
                <tr>
                    ...
                    <td style="width: 250px;">
                        <el-checkbox
                            v-show="accessLevel.deleteLevels.length > 0"
                            :indeterminate="deleteLevels.isIndeterminate"
                            v-model="deleteLevels.checkAll"
                            @change="handleLevelCheckAllChange($event, searchLevels, 0)"
                            >全选</el-checkbox
                        >
                        <br />
                        <el-checkbox-group
                            v-model="deleteLevels.checkedCities"
