	...
	<div>
		...
		<el-dialog title="添加" :visible.sync="addVisible" width="50%">
				...
				<div class="data-content">
					<el-col :span="12" class="data-left">
						...
						<el-row>
							<el-card class="box-card" shadow="hover" style="width:90%;margin-top:10px;">
								<div v-for="o in 4" :key="o" :class="['text item', select == o ? 'select' : '']" @click="selectItem(o)">
									{{ 'SPOT- ' + o }}
								</div>
							</el-card>
						</el-row>
					...
					<el-col :span="12" class="data-right">
						<el-col :span="24">
							...
							<div class="yesType">
								<dvi class="item">0级编目数据</dvi>
								<div class="item">标准产品</div>
								<div class="item">深加工产品</div>
							</div>
						</el-col>
						<el-col :span="24">
							<div class="type-title">
			...
			<el-row style='margin:20px 0;dispaly:flex;justify-content:end;float:right;'>
				<el-button @click="addVisible = false">应用</el-button>
