            ...
            >
                ...
                <el-table-column label="操作" width="280" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-button type="text" icon="el-icon-edit" @click="handleEdit(scope.$index, scope.row)">详情
                        </el-button>
                    ...
                    <div class="data-content">
                        ...
                        <el-row>
                            <el-col :span="18" style="display: flex;">
                                <el-form-item label="存储时间:">
                                    <el-input-number v-model="storageTime" :min="1" :max="100"
                        ...
                        <el-row>
                            <el-col :span="18" style="margin-bottom: 20px;">
                                <el-checkbox v-model="checked" style="margin-right:10px;margin-top: 5px;">提升数据下载热度
                                </el-checkbox>
                        ...
                        <el-row>
                            <el-col :span="18" style="display: flex;">
                                <el-checkbox v-model="checked" style="margin-right:10px;margin-top: 5px;">减少数据存储时间
                                </el-checkbox>
